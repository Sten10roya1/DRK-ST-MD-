...
Database:  ${(isMongodb ? "MongoDb" : sqldb ? "PostegreSql" : "TalkDrove Default")}
\tOther Variables
...
Goodbye Msg: ${global.gdbye}`;
      try {
        ...
        if (_0x4cf26d.total !== 0) {
          _0x1f88ec += "\nHEY DEAR UPDDATE AVAILABLE OF BYTE\nRedeploy Bot as Soon as Possible!\n";
        }
      } catch (_0x16375a) {}
      global.qr_message = {
...
<div class="bounce-text">YOUR BYTE IS SUCESSFULLY DEPLOYED</body>
</html>
...
app.listen(quickport, () => console.log("BYTE-MD on  http://localhost:" + quickport + "/  "));
  ...
  if (_0x40fbb4) {
    ...
    if (_0x148358 && /guru/gi.test(_0x148358) && _0x148358.length < 30) {
      try {
        ...
        log("EMPTY SESSION_ID FROM TALKDROVE SERVER\nPLEASE SCAN THE QR AGAIN FROM [ " + global.scan + " ]\n\n\nERROR: ", _0xc1bebf);
      }
